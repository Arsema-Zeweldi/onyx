  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute bottom-1/4 left-1/4 w-72 h-72 bg-purple-500/10 rounded-full blur-[80px] animate-float"
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <span className="text-neon font-mono text-sm tracking-wider uppercase mb-4 block">
              Get in touch
            </span>
            <h2 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight">
              Let's build something{" "}
              <span className="font-cursive text-neon text-5xl md:text-7xl relative inline-block transform -rotate-2">
                extraordinary
              </span>
            </h2>
            ...
            <div className="space-y-6">
              {/* <a
                ...
                className="flex items-center gap-6 text-slate-300 group hover:text-white transition-all p-4 rounded-xl hover:bg-white/5 border border-transparent hover:border-white/5"
              >
          ...
          >
            <div className="absolute -inset-1 bg-linear-to-r from-neon/20 to-purple-500/20 rounded-4xl blur-xl opacity-50" />
            <div className="relative bg-navy-900/80 backdrop-blur-xl p-8 md:p-10 rounded-4xl border border-white/10 shadow-2xl">
              <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="group">
                    <label className="block text-xs uppercase font-bold text-slate-500 mb-2 group-focus-within:text-neon transition-colors ml-1">
                      Name
                    </label>
                    <input
                      type="text"
