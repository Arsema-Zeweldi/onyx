...
const Services: React.FC = () => {
  return (
    <section
      id="services"
      className="relative py-32 bg-navy-950 text-slate-100 overflow-hidden"
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <span className="text-neon text-sm font-mono tracking-widest uppercase mb-2 block">
            Capabilities
          </span>
          ...
          <p className="text-slate-400 max-w-2xl mx-auto text-lg">
            We deliver end-to-end technical solutions designed for growth,
